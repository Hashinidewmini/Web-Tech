  ...
  return (
    <>
      ...
      <div className='content' style={{
        ...
        <img src='public/images/1.jpg' alt="" style={{ float: 'left' }} />
        <div style={{
      ...
      <div className='content' style={{
        ...
        <img src='public/images/2.jpg' alt="" style={{ float: 'right', marginRight: '2%' }} />
        <div style={{
      ...
      <div className='content' style={{
        ...
        <img src='public/images/3.jpg' alt="" style={{ float: 'left', marginLeft: '2%' }} />
        <div style={{
          float: 'left', color: 'black',
          marginLeft: '20%',
          marginTop: '7%'
      ...
      <div className='content' style={{
        ...
        <img src='public/images/4.jpg' alt='' style={{ float: 'right', marginRight: '2%' }} />
        <div style={{
          float: 'right',
          color: 'white',
          marginRight: '20%',
